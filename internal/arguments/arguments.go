...
func GetArgs() Args {
	...
	merge_output := parser.Flag("m", "merge-output", &argparse.Options{Help: "Merge sample output counts into a single file.  Not necessary when there is only one sample"})
	...
	args.Merge_output = *merge_output
